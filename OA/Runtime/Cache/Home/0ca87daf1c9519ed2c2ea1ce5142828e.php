     ...
     <body>
       <div class="list_box">
           <div class="header">
               ...
               <span class="two"><a href="<?php echo U('Home/Project/process_list');?>">【返回】</a></span>
           </div>
           <div class="bottom">
           <form action="/Company_crm/index.php/Home/Project/process_edit" method="post" enctype="multipart/form-data"  onsubmit="return checks();">
               <table class="table_2" border="1" cellspacing="0" bordercolor="#CCCCCC">                 
                ...
                <tr>
                    <td>任务开始时间</td>
                    <td><input type="text"  name="task_ctime"   value="<?php echo ($arr["task_ctime"]); ?>"    id="begin_time"  style="width:200px;"/></td>
                </tr>
                 <tr>
                    <td>任务结束时间</td>
                    <td><input type="text"  name="task_ltime"  value="<?php echo ($arr["task_ltime"]); ?>"    id="end_time"  style="width:200px;"/></td>
                </tr>    
                <tr>
