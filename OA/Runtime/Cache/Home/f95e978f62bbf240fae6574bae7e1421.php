    ...
    <body>
       <div class="list_box">
           <div class="header">
               ...
               <span class="two"><a href="/Company_crm/index.php/Home/Develop/task_add">【添加任务】</a></span>
           </div>
           <div class="main">
            <form action="/Company_crm/index.php/Home/Develop/task_list" method="get" class="form">
           ...
           <div class="bottom">
               <table class="table_1" border="1" cellspacing="0" bordercolor="#CCCCCC">
                    ...
                    <?php if(is_array($arr)): $i = 0; $__LIST__ = $arr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vv): $mod = ($i % 2 );++$i;?><tr id="product1">
                        ...
                        <td>
	                        <a href="/Company_crm/index.php/Home/Develop/task_edit/p/<?php echo ($p); ?>/id/<?php echo ($vv['task_id']); ?>">修改 </a>
	                        <a href="javascript:delone(<?php echo ($vv['task_id']); ?>,<?php echo ($p); ?>);">删除</a><br>
	                        <a href="/Company_crm/index.php/Home/Develop/task_process/id/<?php echo ($vv['task_id']); ?>">进度管理</a>
                       </td>
