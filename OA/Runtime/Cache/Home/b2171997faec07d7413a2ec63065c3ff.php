...
<html>
    ...
    <body>
       <div class="list_box">
           <div class="header">
               ...
               <span class="two"><a href="/Company_crm/index.php/Home/Project/task_add">【添加任务】</a></span>
           </div>
           <div class="main">
            <form action="/Company_crm/index.php/Home/Project/task_list" method="get" class="form">
                   任务名称： <input type="text" name="rw" value="<?php echo ($title); ?>"  />&nbsp;        
           ...
           <div class="bottom">
               <table class="table_1" border="1" cellspacing="0" bordercolor="#CCCCCC">
                    ...
                    <?php if(is_array($arr)): $i = 0; $__LIST__ = $arr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vv): $mod = ($i % 2 );++$i;?><tr id="product1">
                        ...
                        <td><?php echo ($vv['task_ltime']); ?></td>
                        <td>
                                 <?php if($vv['status'] == 0): ?>未开始
                        ...
                        <td> 
                                 <?php echo ($vv['item_fzr']); ?>
                        </td>
                        <td>
	                        <a href="/Company_crm/index.php/Home/Project/task_edit/p/<?php echo ($p); ?>/id/<?php echo ($vv['task_id']); ?>">修改 </a>
	                        <a href="javascript:delone(<?php echo ($vv['task_id']); ?>,<?php echo ($p); ?>);">删除</a><br>
	                        <a href="/Company_crm/index.php/Home/Project/task_process/id/<?php echo ($vv['task_id']); ?>">进度管理</a>
                       </td>
    ...
    function delone(ids,curp){
   	   if(confirm('确定删除吗？'))
   	   {
   		      $.post("<?php echo U('Project/task_delone');?>",{"act":"del","ids":ids},function(d){
   		    	  alert(d.info);
   		    	  location.href="<?php echo U('Home/Project/task_list/p/"+curp+"');?>";
   		      },"json");
   	   }
   ...
   //全删的操作
    function delAll()
    {
   	 ...
   	 $.post("<?php echo U('Project/task_delall');?>",{"act":"delall","idstr":idstr},function(d){
   		 alert(d.info);
   		 location.href="<?php echo U('Project/task_list');?>";
   	 },"json");
    }
