...
<html>
    ...
    <body>
       <div class="list_box">
           <div class="header">
               ...
               <span class="two"><a href="/Company_crm/index.php/Home/Client/client_add">【添加客户】</a></span>
           </div>
           <div class="main">
            <form action="/Company_crm/index.php/Home/Client/client_list" method="get" class="form">
           ...
           <div class="bottom">
               <table class="table_1" border="1" cellspacing="0" bordercolor="#CCCCCC">
                    ...
                    <?php if(is_array($conten)): $i = 0; $__LIST__ = $conten;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vv): $mod = ($i % 2 );++$i;?><tr id="product1">
                        ...
                        <td>
	                        <a href="/Company_crm/index.php/Home/Client/client_edit/p/<?php echo ($p); ?>/id/<?php echo ($vv['id']); ?>">修改 </a><br>
    ...
    function delone(ids,curp){
   	   if(confirm('确定删除吗？'))
   	   {
   		      $.post("<?php echo U('Client/client_delone');?>",{"act":"del","ids":ids},function(d){
   		    	  alert(d.info);
   		    	  location.href="<?php echo U('Home/Client/client_list/p/"+curp+"');?>";
   		      },"json");
   	   }
   ...
   //全删的操作
    function delAll()
    {
   	 ...
   	 $.post("<?php echo U('Home/Client/client_delall');?>",{"act":"delall","idstr":idstr},function(d){
   		 alert(d.info);
   		 location.href="<?php echo U('Client/client_list');?>";
   	 },"json");
    }
